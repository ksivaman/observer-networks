...
if (new_accuracy != -1):
    print('Accuracy of detecting adversarial samples on CIFAR-10 using Deep-Fool attack is: {}%'.format(new_accuracy * 100))    
cifar_classifier.save('cifar_df_state_dict', 'models')

print('exiting cifar-deep fool...')
